...
extern
fun parse_d2exparg (s2parsingenv, parsingenv, jsonval): d2exparg

(* ****** ****** *)

extern fun parse_d2lab (s2parsingenv, parsingenv, jsonval): d2lab
extern fun parse_d2lab_node (s2parsingenv, parsingenv, jsonval): d2lab

(* ****** ****** *)
//
extern
fun
parse_d2exp_node (s2parsingenv, parsingenv, jsonval): d2exp_node
//
(* ****** ****** *)
...
val node = parse_d2exp_node (s2env, p2env, jsv)
//
in
...
parse_d2explst
  (s2env, p2env, jsv0) = let
in
  parse_list<d2exp> (jsv0, lam x => parse_d2exp (s2env, p2env, x))
end (* end of [parse_d2explst] *)
//
implement
parse_d2expopt
  (s2env, d2cstmap, jsv0) = (
  parse_option<d2exp> (jsv0, lam x => parse_d2exp (s2env, d2cstmap, x))
) (* end of [parse_d2expopt] *)
//
(* ****** ****** *)

extern
fun parse_D2Ecst (s2parsingenv, d2cstmap, jsonval): d2exp_node
extern
fun parse_D2Evar (s2parsingenv, d2varmap, jsonval): d2exp_node
extern
...
extern
fun parse_D2Elet (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Eapplst (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Eifhead (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Ecasehead (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Esing (s2parsingenv, parsingenv, jsonval): d2exp_node
extern
fun parse_D2Elist (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Etup (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Eseq (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Eselab (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Elam_dyn (s2parsingenv, parsingenv, jsonval): d2exp_node
extern
fun parse_D2Elam_sta (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_D2Eann_seff (s2parsingenv, parsingenv, jsonval): d2exp_node
extern
fun parse_D2Eann_type (s2parsingenv, parsingenv, jsonval): d2exp_node
extern
fun parse_D2Eann_funclo (s2parsingenv, parsingenv, jsonval): d2exp_node
extern
fun parse_D2Eextfcall (s2parsingenv, parsingenv, jsonval): d2exp_node
extern
fun parse_D2Eassgn (s2parsingenv, parsingenv, jsonval): d2exp_node

extern
fun parse_c2lau (s2parsingenv, parsingenv, jsonval): c2lau
extern
fun parse_c2laulst (s2parsingenv, parsingenv, jsonval): c2laulst
...
case+ name of
//
| "D2Ecst" => parse_D2Ecst (s2env, p2env.parsingenv_d2cstmap, jsv2)
| "D2Evar" => parse_D2Evar (s2env, p2env.parsingenv_d2varmap, jsv2)
...
//
| "D2Elet" => parse_D2Elet (s2env, p2env, jsv2)
//
| "D2Eapplst" => parse_D2Eapplst (s2env, p2env, jsv2)
//
| "D2Eifhead" => parse_D2Eifhead (s2env, p2env, jsv2)
| "D2Ecasehead" => parse_D2Ecasehead (s2env, p2env, jsv2)
//
| "D2Esing" => parse_D2Esing (s2env, p2env, jsv2)
| "D2Elist" => parse_D2Elist (s2env, p2env, jsv2)
//
| "D2Etup" => parse_D2Etup (s2env, p2env, jsv2)
| "D2Eseq" => parse_D2Eseq (s2env, p2env, jsv2)
//
| "D2Eselab" => parse_D2Eselab (s2env, p2env, jsv2)
//
| "D2Elam_dyn" => parse_D2Elam_dyn (s2env, p2env, jsv2)
| "D2Elam_sta" => parse_D2Elam_sta (s2env, p2env, jsv2)
//
| "D2Eann_seff" => parse_D2Eann_seff (s2env, p2env, jsv2)
| "D2Eann_type" => parse_D2Eann_type (s2env, p2env, jsv2)
| "D2Eann_funclo" => parse_D2Eann_funclo (s2env, p2env, jsv2)
| "D2Eextfcall" => parse_D2Eextfcall (s2env, p2env, jsv2)
| "D2Eassgn" => parse_D2Eassgn (s2env, p2env, jsv2)
//
| s (*rest*) => let
...
val d2cs = parse_d2eclist (s2env, p2env, jsvs[0])
val d2e_body = parse_d2exp (s2env, p2env, jsvs[1])
//
in
...
val-JSONarray(jsvs) = jsv0
val () = assertloc (length(jsvs) >= 2)
val d2e_fun = parse_d2exp (s2env, p2env, jsvs[0])
val d2as_arg = parse_list<d2exparg> (jsvs[1], 
                                     lam x => parse_d2exparg (s2env, p2env, x))
//
in
...
//
val _test = parse_d2exp (s2env, p2env, jsvs[1])
val _then = parse_d2exp (s2env, p2env, jsvs[2])
val _else = parse_d2expopt (s2env, p2env, jsvs[3])
//
in
...
implement parse_c2laulst (s2env, p2env, jsv0) = let
in
  parse_list<c2lau> (jsv0, lam x => parse_c2lau (s2env, p2env, x))
end

implement parse_c2lau (s2env, p2env, jsv0) = let
  ...
  val c2lau_body = parse_d2exp (s2env, p2env, jsv_body)
...
val-JSONarray(jsvs) = jsv0
val () = assertloc (length(jsvs) >= 1)
val d2es = parse_d2explst (s2env, p2env, jsvs[0])
//
in
  D2Eseq (d2es)
...
val () = assertloc (length(jsvs) >= 2)
val d2e = parse_d2exp (s2env, p2env, jsvs[0])
val d2ls = parse_list<d2lab> (jsvs[1], lam x => parse_d2lab (s2env, p2env, x))
//
in
  D2Eselab (d2e, d2ls)
...
implement
parse_D2Eextfcall (s2env, p2env, jsv0) = let
//
val-JSONarray(jsvs) = jsv0
val () = assertloc (length(jsvs) >= 3)
...
implement
parse_D2Eassgn (s2env, p2env, jsv0) = let
//
val-JSONarray(jsvs) = jsv0
val () = assertloc (length(jsvs) >= 2)
val exp_left = parse_d2exp (s2env, p2env, jsvs[0])
val exp_right = parse_d2exp (s2env, p2env, jsvs[1])
in
...
in
  parse_d2lab_node (s2env, p2env, jsv)
